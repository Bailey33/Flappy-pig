...
namespace FlappyBird
{
	public class Bird
	{
		...
		{
			textureInfo  = new TextureInfo("/Application/textures/Pig.png");
		...
		{			
			...
			//Create Bounding box
			boundBox = new Rectangle(sprite.Position.X, sprite.Position.Y,sprite.TextureInfo.Texture.Width, sprite.TextureInfo.Texture.Height);
			//Console.WriteLine(boundBox);
